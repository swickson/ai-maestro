...
- ✅ **Initial repo allowlist (5 repos):** `swickson/ai-maestro`, `aimaestro-gateways`, Ziggy, **N4 Safety** (own repo), **Alliance OS** (own repo). *(exact owner/repo slugs for the latter three TBD at wiring — see open #2.)*
