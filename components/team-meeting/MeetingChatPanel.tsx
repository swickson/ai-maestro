...
import { Send, Users, User, AlertTriangle, Play, X, Loader2 } from 'lucide-react'
  ...
  const inner = (
    <div className="flex flex-col h-full min-h-0">
      ...
      <div className="flex-1 min-h-0 overflow-y-auto px-3 py-2 space-y-2">
        ...
        {/* Activity indicators — real-time agent processing status (X-Ray mode, post-fork gain kept) */}
        {(() => {
